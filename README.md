...
- Dispositivo médico portátil (wearable) para detectar arritmias utilizando la señal ECG y aprovechando la energía del cuerpo a través de métodos de recolección de energía(energy harvesting). Este proyecto, debido a problemas de falta de suministro de componentes, no se llevó a cabo el montaje físico del dispositivo, pero si el prototipo virtual. 
